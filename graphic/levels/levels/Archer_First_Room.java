...
public class Archer_First_Room extends StandartLevel implements ObjectsStates {
...
if(Main.save.avancement>=3) {
	...
	public void speakToLevel(int i) {
		...
		case 3:
			...
			solidList[4][9] = true;
			solidList[5][9] = true;
			Main.save.classe = classes.ARCHER;
