...
public class Guerrier_First_Room extends StandartLevel implements ObjectsStates {
...
if(Main.save.avancement>=3) {
	...
	public void speakToLevel(int i) {
		...
		case 3:
			...
			coffre.setState(coffre_state.OPEN);
			win = true;
			player.giveItem(new BasicSword());
			...
			solidList[4][9] = true;
			solidList[5][9] = true;
			Main.save.classe = classes.GUERRIER;
